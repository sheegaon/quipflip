...
export interface RoundAvailabilityQF {
  can_prompt: boolean;
  can_copy: boolean;
  can_vote: boolean;
...
export interface RoundDetailsQF {
  round_id: string;
  type: string;
  status: string;
  expires_at: string;
...
export interface DashboardData {
  ...
  round_availability: RoundAvailabilityQF;
}
...
// ============================================================================
// ThinkLink (TL) Specific Types
// ============================================================================

/**
 * TL-specific types for single-round word guessing game
 */
...
export interface TLGuessDetail {
  guess_id: string;
  text: string;
  was_match: boolean;
  matched_cluster_ids: string[];
...
export type TLTutorialProgress = 'not_started' | 'welcome' | 'dashboard' | 'gameplay' | 'scoring' | 'strategy' | 'completed';

export interface TLTutorialStatus {
  tutorial_completed: boolean;
...
// ============================================================================
// Type Aliases for Backward Compatibility (TL Client imports)
// ============================================================================
// These aliases allow the TL-specific client and components to use
// the original type names while maintaining separation from QF/MM types

export type DashboardResponse = TLDashboardResponse;
export type RoundAvailability = TLRoundAvailability;
export type GuessDetail = TLGuessDetail;
export type RoundDetails = TLRoundDetails;
