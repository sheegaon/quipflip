...
import { MMQuest, MMQuestCategory, MMQuestStatus } from '@crowdcraft/api/types.ts';
...
export const QuestCard: React.FC<QuestCardProps> = ({
  ...
  const getCategoryInfo = (category: MMQuestCategory): CategoryInfo => {
    switch (category) {
      case 'streak':
        return {
  ...
  // Get status badge
  const getStatusBadge = (status: MMQuestStatus) => {
    switch (status) {
      case 'active':
        return (
