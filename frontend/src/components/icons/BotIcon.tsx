...
export const BotIcon: React.FC<BotIconProps> = ({ className = 'h-4 w-4' }) => {
  return (
    ...
    >
      ...
      {/* Eyes */}
      <circle cx="9.5" cy="11" r="1.5" fill="#FFF6EE" />
      <circle cx="14.5" cy="11" r="1.5" fill="#FFF6EE" />

      {/* Mouth/speaker grille */}
      <line x1="9" y1="15" x2="15" y2="15" stroke="#FFF6EE" strokeWidth="1.2" strokeLinecap="round" />
      ...
      {/* Legs */}
      <rect x="8" y="18" width="2" height="3" rx="0.5" />
      <rect x="14" y="18" width="2" height="3" rx="0.5" />
    </svg>
  );
};
