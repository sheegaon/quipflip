...
async def get_current_player(
    ...
    Now uses unified Player model regardless of game_type.
    game_type is kept as parameter for backward compatibility but not used.
    ...
    # Use unified AuthService (game_type only used for player_service in registration)
    ...
    # Query unified Player model directly
