...
down_revision: str | None = "f0f0d0b1c2a3"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("tutorial_completed", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column("first_vote_awarded", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column("first_vote_bonus_applied", sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column("used_free_slot", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=timestamp_default),
        sa.ForeignKeyConstraint(["player_id"], ["mm_players.player_id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["image_id"], ["mm_images.image_id"], ondelete="CASCADE"),
