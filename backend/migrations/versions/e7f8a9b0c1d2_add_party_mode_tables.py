...
def upgrade() -> None:
    ...
    op.create_table(
        'party_participants',
        sa.Column('participant_id', uuid, primary_key=True, server_default=sa.text('gen_random_uuid()')),
    ...
    op.create_table(
        'party_rounds',
        sa.Column('party_round_id', uuid, primary_key=True, server_default=sa.text('gen_random_uuid()')),
        sa.Column('session_id', uuid, sa.ForeignKey('party_sessions.session_id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_table(
        'party_phrasesets',
        sa.Column('party_phraseset_id', uuid, primary_key=True, server_default=sa.text('gen_random_uuid()')),
        sa.Column('session_id', uuid, sa.ForeignKey('party_sessions.session_id', ondelete='CASCADE'), nullable=False),
