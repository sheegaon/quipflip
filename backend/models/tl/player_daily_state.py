...
class TLPlayerDailyState(Base):
    """Per-player daily counters for free caption submissions."""

    __tablename__ = "tl_player_daily_states"
    ...
    # Relationships
    player = relationship("TLPlayer", back_populates="daily_states")
    ...
    def __repr__(self) -> str:
        return (
            f"<TLPlayerDailyState(player_id={self.player_id}, date={self.date}, "
